...
#x   - For the validation related to the conventional helicopter case, Bell 505 is considered:                                                                                               x
#x     https://www.bellflight.com/-/media/site-specific/bell-flight/documents/products/505/bell-505-product-specifications.pdf?la=en&hash=D295CEE8CDCBAB8ABC737B3C79056B6D                   x                                                                                                    x
...
#x                                                                                                                                                                                           x
#x To use the 'parasite_fus.py' function, it is necessary to instantiate the DataImport class by assigning a value to the following attributes:                                              x                                                                                                      x
#x   1) Re_inf: asymptotic Reynolds number based on fuselage length                                                                                                                          x                                                           x
...
#x   4) S: reference area (rotor disk area)                                                                                                                                                  x                                     x
...
from parasite_fus import DataImport                        # Importing the DataImport class

# Input parameters to be used to study the Bell 505 helicopter (input parameters to be used to study the Lockheed AH-56A Cheyenne compound helicopter are shown in parentheses)
