...
def Mission_profile(Helicopter, SFC, Pd, height_c, MTOW, Voo, Voo_d, height_h, time_h,\
    ...
    climb_data = {
            "Altitude": "To " + f"{round(height_c * meters_to_feet)}",   # Round to integer for readability
            "Speed ": round(TAS_c,1),                                    # Round to 1 decimal for readability
    ...
    forward_data = {
        "Altitude": round(height_f * meters_to_feet),                             
        "Speed ": round(Vinf * meters_per_second_to_knots,1),
        "Distance": round (dist_f * meters_to_nautical_miles,1),
        "Time": round(time_f),
    ...
    Descend_data = {
        "Altitude": "To " + f"{round(height_d * meters_to_feet)}",
        "Speed ": round(TAS_d,1),
        "Distance": round (dist_d * meters_to_nautical_miles,1),
        "Time": round(time_d),
        "Power Rating": "-",
    ...
    hover_data = {
        "Altitude": round(height_h * meters_to_feet),
        "Speed ": "-",
        "Distance": "-",
        "Time": time_h,
    ...
    forward_data2 = {
        "Altitude": round(height_f2 * meters_to_feet),
        "Speed ": round(Vinf * meters_per_second_to_knots,1),
        "Distance": round (dist_f2 * meters_to_nautical_miles,1),
        "Time": round(time_f2),
